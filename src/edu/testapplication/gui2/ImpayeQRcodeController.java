...
*/
       ...
       FXMLLoader loader = new FXMLLoader(getClass().getResource("ImpayeFact.fxml"));
        ImpayeFactController fc = new ImpayeFactController();
        Parent root =loader.load();
        ImpayeFactController ifc1 = loader.getController();
        


      // Récupération des valeurs des champs à partir du contrôleur de vue
       System.out.println(ifc1.getStatut());
String statutValue = ifc1.getStatut();
