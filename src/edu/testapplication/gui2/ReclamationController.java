...
//        String cin = cinrec.getText();
        String telephone = typeR.getText();
        String objet = objetR.getText();
        String message = messageR.getText();
        Date date = Date.valueOf(dateR.getValue());
        
        Reclamation t = new Reclamation(cinrec.getText(), telephone, objet, message, date);
    ...
    public void showsReclamation() {
        ...
        for (Reclamation reclamation : r) {
            ...
            trimmed.setTelephone(reclamation.getTelephone());
        ...
        typeRe.setCellValueFactory(new PropertyValueFactory<>("telephone"));
