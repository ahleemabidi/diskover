...
import edu.esprit.services.Crudcolaboration;
import edu.esprit.services.Crudreservation;
    ...
    private void listepdf(ActionEvent event) {
        ...
        try {
            PdfWriter.getInstance(document,
                    new FileOutputStream("C:\\Users\\lenovo\\Desktop\\PIDEV\\Disk-over-user\\Reservation.pdf"));
            ...
            //IMAGES
            Image img1 = Image.getInstance("C:\\Users\\lenovo\\Desktop\\PIDEV\\Disk-over-user\\src\\images\\logo.png");
            ...
            Image img2 = Image.getInstance("C:\\Users\\lenovo\\Desktop\\PIDEV\\Disk-over-user\\src\\images\\sign.png");
...
//            Events e = new Events();
            document.add(new Paragraph(" "));
            document.add(new Paragraph(" "));
            document.add(new Paragraph("Cher Client, "+nom.getText()+" de Cin : " + cinres.getText() +""  ));
            ...
            Desktop.getDesktop().open(new File("C:\\Users\\lenovo\\Desktop\\PIDEV\\Disk-over-user\\Reservation.pdf"));
