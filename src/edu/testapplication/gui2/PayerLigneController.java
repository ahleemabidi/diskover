...
import edu.testapplication.gui2.FactureController;
...
public class PayerLigneController implements Initializable {
    ...
    @FXML
    private ChoiceBox<String> tfsource;
    ObservableList<String> choice_s = FXCollections.observableArrayList("tok_visa");
    @FXML
    private ChoiceBox<String> tfdevice;
    ObservableList<String> choice_d = FXCollections.observableArrayList("usd");
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     tfdevice.setItems(choice_d);
     tfsource.setItems(choice_s);
    ...
    private void payer(ActionEvent event) {
        ...
        String devise = tfdevice.getValue();
        String source = tfsource.getValue();
